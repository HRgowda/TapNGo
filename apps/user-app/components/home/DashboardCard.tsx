    ...
    <div className="w-full px-4 lg:px-0 text-white">
      <Card title="">
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          ...
          {card ? <div className="w-full lg:w-1/3 flex items-center justify-center mt-8 lg:mt-0">
            <CreditCard
              name={fullName}
          ...
          : <Link href={'card_data'}>
            <button
              className="w-full h-full p-4 flex flex-col justify-center items-center text-3xl font-bold text-green-200 border-2 border-blue-300 rounded-2xl border-dashed cursor-pointer transition duration-200 hover:scale-105">
              <div>+</div>
