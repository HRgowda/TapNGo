...
import 'app/animations/Animation.css'; // Import the animation styles
      ...
      <div className="space-y-8 md:space-y-16">
        <div className="credit-card w-full max-w-xs md:max-w-md lg:max-w-lg h-48 md:h-56 bg-red-100 rounded-xl relative text-white shadow-2xl">
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <span className="text-5xl text-white opacity-20 transform rotate-[-30deg] pointer-events-none select-none z-0">
              tapNgo
            </span>
          </div>
          ...
          <div className="w-full px-4 md:px-8 absolute top-4 md:top-8">
            ...
            <div className="pt-1">
              ...
              <p className="text-sm md:text-base font-medium tracking-more-wider">{formattedCardNumber}</p>
            </div>
