export function GoalsInitialUi() {
  return (
      ...
      {/* Vision Vault Introduction */}
        <div className="p-8 bg-gray-800 rounded-lg shadow-2xl">
          ...
          <div className="mt-10 text-center">
            <button className="bg-gradient-to-r from-blue-500 to-blue-700 text-white py-3 px-8 rounded-full hover:from-blue-700 hover:to-blue-500 transition-colors duration-300 shadow-xl">
              Start Saving Today
            </button>
          </div>
